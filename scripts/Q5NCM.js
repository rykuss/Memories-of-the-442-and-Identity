...
function main()
{
	...
	{
		item.innerHTML = "<button type=\"button\" id=\"choice1\" onclick=\"location.href=\'random3NCM.html\'\">Worth it</button> " + 
                         "<button type=\"button\" id=\"choice2\" onclick=\"location.href=\'random3NCM.html\'\">Outraged</button>\" ";
		//update opinion and pts
	}
