...
function main()
{
	...
	if(captured == true)
	{
		item.innerHTML = "<button type=\"button\" id=\"continue\" onclick=\"location.href=\'random2CH.html\'\">Continue</button>";
		points[1] += 1;
		points[3] += 1;
		points[4] += 1;
	}
	...
	{
		item.innerHTML = "<button type=\"button\" id=\"continue\" onclick=\"location.href=\'random2NCH.html\'\">Continue</button>";
		points[11] += 1;
		points[2] += 1;
		points[9] += 1;
	}
